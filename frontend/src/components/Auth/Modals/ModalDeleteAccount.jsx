...
function ModalDeleteAccount({ isOpen, onClose, backendURL, userId, setIsLogged, setShouldRedirect }) {
    if (!isOpen) {
      return null;
    }
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div className="w-1/3 rounded-lg bg-white p-8 shadow-lg">
          <p className="mb-4 text-center">
            <AiFillWarning size={33} className="inline-block align-middle text-orange-500" />
